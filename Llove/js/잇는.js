...
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   '잇는' 포탈 — 이세계(끝말잇기 게임 차원, 임시 이름 '잇는' — 최종 미정) 진입 관문
   ...
   ℹ️ 이 퍼즐의 90° 회전은 '게임(wchain)의 관문'이라 회전 자체가 본질이다(CLAUDE.md 행동
     규칙 8번은 방식을 제한하지 않고 통일성·불쾌감 없음 기준으로 판단 — 이 퍼즐은 그 기준을
     그대로 통과한다). 일반 학습 UI는 여전히 fadeUp/slideIn 톤을 기본으로 쓴다.
   ⚠️ 세계/포탈 표시 이름은 미정 → 임시 '잇는'. 확정 시 표시 문자열·필드명(잇는개방) 일괄 치환.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */

// 이세계 진입 경로 (같은 도메인 형제 폴더 — 로그인 자동 공유)
// 저장소 재편: 루트 = 관문 index.html + Llove/ + wchain/ → Llove/ 페이지 기준 상대경로
const 잇는_경로 = '../wchain/';
