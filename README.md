...
## 주요 기능
- 7가지 학습 모드: 상식·어원 / 세계사·신화 / 고사성어·속담 / 한자·우리말 / 맞춤법 / 아재개그 / 구어 교정
- 플래시카드 · 4지선다 · 역방향 · 뜻 직접 서술 · 유의어 변별 등 출제 방식 선택
- 복습 대기열(전용 복습 화면) · 업적 · 레벨/소칭호 성장 시스템
- 테마(프리셋 5종 + **커스텀 테마 에디터**) · 글꼴 10종 · **글자 크기 조절(80~200%)**
- 구어 교정 **음성 입력**(브라우저 Web Speech API, 한국어)
- Firebase(구글 로그인 + Firestore) 연동
